  ...
  async fetch(request, env) {
        ...
        <body>
          <div id="frank-chat-messages">
            <div class="message assistant">
              Hi, I'm Frank's digital assistant. Ask about my executive project controls experience, capital programs, or AI strategies.
            </div>
          </div>
          ...
          <script>
            ...
            async function sendMessage() {
              ...
              try {
                const res = await fetch("https://frank-digital-twin.frank-digital-twin.workers.dev/api/chat", {
                  method: "POST",
    ...
    if (url.pathname === "/api/chat" && request.method === "POST") {
      try {
        ...
        const systemPrompt = `You are Frank's Digital Twin, an AI representative for Frank.
